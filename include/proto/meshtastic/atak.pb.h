...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_TAKPacket> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 7;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_TAKPacket_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_TAKPacket_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_GeoChat> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_GeoChat_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_GeoChat_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_Group> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_Group_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_Group_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_Status> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_Status_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_Status_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_Contact> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_Contact_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_Contact_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_PLI> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 5;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_PLI_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_PLI_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
