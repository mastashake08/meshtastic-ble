...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_PowerMon> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 0;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_PowerMon_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_PowerMon_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_PowerStressMessage> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_PowerStressMessage_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_PowerStressMessage_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
