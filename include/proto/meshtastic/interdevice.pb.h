...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_SensorData> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_SensorData_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_SensorData_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_InterdeviceMessage> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_InterdeviceMessage_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_InterdeviceMessage_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
