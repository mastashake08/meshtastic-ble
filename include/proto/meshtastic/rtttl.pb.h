...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_RTTTLConfig> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_RTTTLConfig_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_RTTTLConfig_msg;
    }
