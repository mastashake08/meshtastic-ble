...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_AdminMessage> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 55;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_AdminMessage_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_AdminMessage_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_AdminMessage_InputEvent> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_AdminMessage_InputEvent_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_AdminMessage_InputEvent_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_HamParameters> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_HamParameters_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_HamParameters_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_NodeRemoteHardwarePinsResponse> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_NodeRemoteHardwarePinsResponse_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_NodeRemoteHardwarePinsResponse_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_SharedContact> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_SharedContact_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_SharedContact_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_KeyVerificationAdmin> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_KeyVerificationAdmin_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_KeyVerificationAdmin_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
