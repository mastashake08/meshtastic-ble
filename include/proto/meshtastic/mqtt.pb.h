...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_ServiceEnvelope> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_ServiceEnvelope_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_MapReport> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 14;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_MapReport_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_MapReport_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
