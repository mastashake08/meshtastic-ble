...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_DeviceConnectionStatus> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_DeviceConnectionStatus_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_DeviceConnectionStatus_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_WifiConnectionStatus> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_WifiConnectionStatus_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_WifiConnectionStatus_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_EthernetConnectionStatus> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_EthernetConnectionStatus_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_EthernetConnectionStatus_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_NetworkConnectionStatus> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_NetworkConnectionStatus_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_NetworkConnectionStatus_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_BluetoothConnectionStatus> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_BluetoothConnectionStatus_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_BluetoothConnectionStatus_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_SerialConnectionStatus> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_SerialConnectionStatus_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_SerialConnectionStatus_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
