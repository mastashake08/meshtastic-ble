...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_CannedMessageModuleConfig> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_CannedMessageModuleConfig_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_CannedMessageModuleConfig_msg;
    }
