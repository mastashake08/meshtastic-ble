...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_HardwareMessage> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_HardwareMessage_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_HardwareMessage_msg;
    }
