...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_ChannelSettings> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 7;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_ChannelSettings_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_ChannelSettings_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_ModuleSettings> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_ModuleSettings_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_ModuleSettings_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_Channel> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_Channel_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_Channel_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
