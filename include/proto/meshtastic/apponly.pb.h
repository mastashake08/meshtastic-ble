...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_ChannelSet> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_ChannelSet_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_ChannelSet_msg;
    }
