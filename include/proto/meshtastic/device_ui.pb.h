...
namespace nanopb {
template <>
struct MessageDescriptor<meshtastic_DeviceUIConfig> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 19;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_DeviceUIConfig_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_DeviceUIConfig_msg;
    }
...
template <>
struct MessageDescriptor<meshtastic_NodeFilter> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 7;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_NodeFilter_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_NodeFilter_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_NodeHighlight> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 5;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_NodeHighlight_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_NodeHighlight_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_GeoPoint> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_GeoPoint_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_GeoPoint_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<meshtastic_Map> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 3;
    static PB_INLINE_CONSTEXPR const pb_size_t size = meshtastic_Map_size;
    static inline const pb_msgdesc_t* fields() {
        return &meshtastic_Map_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
